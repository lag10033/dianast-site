...
const ЗаявкаБухгалтеру = (function () {
  ...
  // ── реквизиты поставщика (дословно, как в счёте бухгалтера) ──
  const ПОСТАВЩИК = {
    name: 'ЧПТУП "Дианаст"',
    addr: 'Республика Беларусь Брестская область г. Кобрин ул. Никольская, 64К',
    tel: '(801642) 5-40-54',
    unp: '291123367', okpo: '300322621000',
    bank: 'Филиал №113 ОАО "АСБ Беларусбанк", г. Кобрин',
    rs: 'BY98AKBB30120229100951100000', bic: 'AKBBBY2X'
  };
...
<div class="sign"><i>Счет выдал</i>___________________________</div>
  ...
  return { открыть, закрыть, клиенты: () => clients, поставщик: ПОСТАВЩИК, суммаПрописью };
})();
