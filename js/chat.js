...
(function(){
  ...
  win.innerHTML =
    '<div class="dch-head"><div class="dch-ava">С</div><div><b>Степаныч · Dianast</b><small>строитель, подскажу по кирпичу и заборам</small></div><button class="dch-close" aria-label="Закрыть">×</button></div>' +
    '<div class="dch-msgs"></div><div class="dch-typing">Степаныч печатает…</div>' +
    '<div class="dch-quick">' +
  ...
  function greet(){
    ...
    fetch(API, {method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({messages:[]})})
      ...
      .catch(function(){ add('assistant', 'Здравствуйте! Спрашивайте про кирпич и заборы.'); });
  }
